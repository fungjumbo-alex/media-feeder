  ...
  const renderContent = () => {
    ...
    return (
      <div className="text-center text-gray-500 py-10">
        Not enough content from downloaded article titles to determine trending keywords. Add more
        feeds or refresh existing ones.
      </div>
    );
  };
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg m-4 relative flex flex-col max-h-[90vh]">
        ...
        <p className="text-gray-400 mb-6 flex-shrink-0">
          Top keywords from the titles of all your downloaded articles, sorted by relevance. Click a
          keyword to see related articles.
        </p>
