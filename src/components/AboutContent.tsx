...
const Feature: React.FC<{ icon: React.ReactNode; title: string; description: React.ReactNode }> = ({
  icon,
  title,
  description,
}) => (
    ...
    <div className="flex-1 overflow-y-auto bg-gray-900 p-6 sm:p-8">
      <div className="max-w-3xl mx-auto bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-400 mb-6">
          A modern, privacy-focused YouTube & RSS feed reader that uses AI to help you discover,
          summarize, and organize content without leaving your browser.
        </p>
        ...
        <div className="space-y-8">
          ...
          <Feature
            ...
            description={
              <>
                Install our Chrome extension to add new feeds directly from any webpage and get a
                quick overview of your unread content.{' '}
                <a
        ...
        <div className="mt-10 pt-6 border-t border-gray-700 text-center">
          ...
          <p className="text-gray-400">Have questions, feedback, or feature requests?</p>
          <a
            href="mailto:fungjumbo@gmail.com"
