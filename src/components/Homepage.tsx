      ...
      <main className="max-w-4xl w-full text-center">
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-400">
            A modern YouTube & RSS feed reader that uses AI to summarize, recommend, and explore
            content.
          </p>
        </header>
        ...
        <footer className="text-sm text-gray-500">
          <p className="mb-2">
            By using Media-Feeder, you agree to its terms. The app requests permissions for your
            Google account to enable features like importing YouTube subscriptions and liking
            videos. All your data is stored locally in your browser.
          </p>
