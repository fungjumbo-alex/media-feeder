...
export const CaptionSelectionModal: React.FC<CaptionSelectionModalProps> = ({
  choices,
  onSelect,
  onClose,
}) => {
    ...
    >
      ...
      <div className="flex-shrink-0">
        ...
        <p className="text-gray-400 mb-6">
          This video has multiple caption languages. Please choose one to generate the transcript.
        </p>
      </div>

      <div className="mb-6">
        <label htmlFor="caption-select" className="sr-only">
          Select Language
        </label>
        <select
          id="caption-select"
