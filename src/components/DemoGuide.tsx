...
const DEMO_STEPS: DemoStep[] = [
    {
        ...
        content: "This quick tour will guide you through the core features. Let's get started by importing some channels from YouTube.",
        position: { top: '50%', left: '50%', transform: 'translate(-50%, -50%)' },
    },
    {
        title: "1. Import from YouTube",
        content: "First, open the 'Actions & Settings' menu, then click 'Import from YouTube' to connect your Google account and select channels.",
        position: { bottom: '80px', left: '20px' },
        highlightSelector: '#actions-menu-button',
    },
    {
        title: "2. Organize with Tags",
        content: "Now that you have feeds, let's organize them. When viewing a feed, you can use the tag icon in the header to add categories.",
        position: { top: '80px', left: '350px' },
        highlightSelector: '#header-tag-button',
    },
    {
        title: "3. Get Latest Content",
        content: "Click the refresh icon in the header to get the latest articles for the current feed. You can also refresh all feeds from the main settings menu.",
        position: { top: '150px', left: '350px' },
        highlightSelector: '#header-refresh-button',
    },
    {
        title: "4. Add Any Source",
        content: "You can add any RSS feed, YouTube channel, or Reddit page manually. Find this option in the 'Actions & Settings' menu.",
        position: { bottom: '150px', left: '20px' },
    },
    {
        title: "5. Sync to Another Device",
        content: "Use 'Actions & Settings' > 'Export Data' > 'Share via Link' to get a unique URL. Open this URL on another device to clone your entire setup.",
        position: { bottom: '80px', left: '20px' },
        highlightSelector: '#actions-menu-button',
    },
    {
        title: "You're All Set!",
        content: "That's a quick look at the main features. Feel free to explore and customize your reading experience. Enjoy!",
        position: { top: '50%', left: '50%', transform: 'translate(-50%, -50%)' },
    },
];
