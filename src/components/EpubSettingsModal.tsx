        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg m-4 relative">
                ...
                <p className="text-gray-400 mb-6">
                    Confirm the title and filename for your EPUB export.
                </p>
                <form onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="epub-title" className="text-sm font-medium text-gray-400">Book Title</label>
                            <input
                                id="epub-title"
                                type="text"
                                value={title}
                                ...
                                required
                            />
                            <p className="text-xs text-gray-500 mt-1">This will be the title inside the EPUB file's metadata.</p>
                        </div>
                        <div>
                            <label htmlFor="epub-filename" className="text-sm font-medium text-gray-400">File Name</label>
                            ...
                            <p className="text-xs text-gray-500 mt-1">This will be the name of the downloaded file.</p>
                        </div>
                    </div>
                    <div className="mt-6 flex justify-end space-x-4">
                        ...
                        <button type="submit" className="px-6 py-2 rounded-md bg-indigo-600 text-white font-semibold hover:bg-indigo-500">
                            Generate EPUB
                        </button>
                    </div>
                </form>
