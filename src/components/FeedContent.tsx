...
export const ArticleReaderView: React.FC<{
    ...
    const observer = new IntersectionObserver(
      entries => {
        ...
        if (visibleEntries.length > 0) {
          const topVisibleIndex = parseInt(
  ...
  if (articles.length === 0) {
    return (
      <div className="text-center text-gray-500 mt-10">No articles to display in reader view.</div>
    );
  }
                  ...
                  <div className="flex-shrink-0 pt-2">
                    ...
                    >
                      <div className="relative h-6 w-6">
                        ...
                        {isSelected && (
                          <svg
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-5 w-5 text-white pointer-events-none"
                            viewBox="0 0 16 16"
                            fill="currentColor"
                          >
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400 flex-wrap">
                      ...
                      <>
                        ...
                        >
                          <BookmarkIcon
                            className={`w-4 h-4 ${isReadLater ? 'fill-current' : ''}`}
                          />
                ...
                <div className="my-6 p-4 bg-gray-800 rounded-lg border border-gray-700">
                  ...
                  {article.structuredSummary ? (
                    <div>
                      ...
                      {article.structuredSummary.sections &&
                        article.structuredSummary.sections.length > 0 && (
...
export const FeedContent: React.FC<FeedContentProps> = ({
  ...
  return <div className="flex-1 overflow-y-auto bg-gray-900">{renderContent()}</div>;
};
