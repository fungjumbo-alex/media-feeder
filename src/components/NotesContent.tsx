          ...
          {notesForView.map(note => (
            ...
            >
              ...
              <div
                ...
                onClick={() => handleOpenNoteEditor(note)}
              >
                <h3 className="font-bold text-lg text-gray-100 truncate group-hover:text-indigo-400 transition-colors">
                  {note.title}
                </h3>
