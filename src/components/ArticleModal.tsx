        ...
        if (videoId) {
            const fetchChoices = async () => {
                ...
                try {
                    ...
                    if (choices.length > 0) setSelectedCaptionUrl(choices[0].url);
                    else setTranscriptError("No transcripts available for this video.");
                } catch (e) { setTranscriptError(e instanceof Error ? e.message : "Could not fetch transcript languages.");
