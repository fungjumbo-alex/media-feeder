...
const NetworkTabContent: React.FC = () => {
    const {
        proxyStats, handleClearProxyStats, disabledProxies, handleToggleProxy,
        refreshBatchSize, setRefreshBatchSize, refreshDelaySeconds, setRefreshDelaySeconds
    } = useAppContext();
    ...
    return (
        <div className="space-y-4">
            <p className="text-gray-400 text-sm">
                ...
                <span className="block mt-1 font-semibold text-indigo-400">The app automatically prioritizes proxies with higher success rates for each feed type.</span> 
...
const StorageTabContent: React.FC = () => {
    ...
    const handleClearClick = () => {
        if (window.confirm("Are you sure you want to clear the articles cache? This can help free up space but may require re-downloading content.")) {
    ...
    return (
        <div className="space-y-4">
            <p className="text-gray-400 mb-6 text-sm">
                This shows the total amount of space the application is using in your browser's local storage.
            </p>
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg m-4 relative flex flex-col max-h-[90vh]">
                ...
                <div className="flex-shrink-0 border-b border-gray-700 mb-4">
                    <nav className="flex space-x-4">
                        ...
                        >
                            <div className="flex items-center gap-2"><BarChartIcon className="w-5 h-5" /> Network</div>
                        </button>
                        <button
                        ...
                        >
                            <div className="flex items-center gap-2"><DatabaseIcon className="w-5 h-5" /> Storage</div>
                        </button>
                    </nav>
                </div>
