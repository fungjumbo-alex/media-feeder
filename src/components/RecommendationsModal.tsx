      ...
      return (
        <div className="text-center flex flex-col items-center justify-center h-full px-4">
          ...
          <p className="text-gray-400 mb-4 max-w-lg">
            Let our AI analyze your subscriptions and reading history to recommend new sources. You
            can add specific requirements below.
          </p>
          <textarea
            value={customQuery}
          ...
          />
          <button
            onClick={() => handleGenerateRecommendations(customQuery)}
            disabled={isLoading}
            className="flex items-center px-6 py-3 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-500 disabled:bg-indigo-400/50 disabled:cursor-not-allowed"
          >
      ...
      return (
        <div className="text-center text-gray-400 p-8 flex flex-col items-center justify-center h-full">
          ...
          <button
            ...
            className="mt-6 px-4 py-2 rounded-md bg-indigo-600 text-white font-semibold hover:bg-indigo-500"
          >
            Start Over
          </button>
        </div>
