...
import { XIcon, SettingsIcon, RefreshIcon, ZapOffIcon, BarChartIcon, GoogleIcon, TagsIcon, TrashIcon, SparklesIcon, InfoIcon, HelpIcon, ChevronDownIcon } from './icons';
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg m-4 relative max-h-[90vh] flex flex-col">
                ...
                <div className="flex-grow overflow-y-auto pr-2 -mr-2 space-y-6">
                                ...
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400 mt-1">
                                            Connect your account to like videos, import subscriptions, and sync data with Google Drive.
                                        </p>
                                    </div>
                                    <button
                                        onClick={() => {
                    ...
                    <div>
                        ...
                        <div className="bg-gray-700/50 p-4 rounded-lg space-y-4">
                            ...
                            <div className="border-t border-gray-600/50 pt-4">
                                <div className="flex justify-between items-center">
                                    <div>
                                        <h4 className={`font-semibold transition-colors ${isAiDisabled ? 'text-yellow-400' : 'text-gray-100'}`}>Auto-generate AI summaries on refresh</h4>
                                        <p className="text-xs text-gray-400 mt-1">
                                            New YouTube videos with transcripts will be automatically summarized after a refresh. This uses your Gemini API quota.
                                        </p>
                                        {isAiDisabled && (
                                            <p className="text-xs text-yellow-500 mt-1">
                                                This was automatically disabled due to repeated API quota errors. You can re-enable it.
                                            </p>
                                        )}
                                    </div>
                                    <label htmlFor="auto-summarize-toggle" className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            type="checkbox"
                             ...
                             <div className="border-t border-gray-600/50 pt-4">
                                <div className="flex justify-between items-center">
                                    <div>
                                        <h4 className={`font-semibold transition-colors ${!isDriveSyncReady ? 'text-gray-500' : 'text-gray-100'}`}>Auto-upload after refresh</h4>
                                        <p className="text-xs text-gray-400 mt-1">
                                            Automatically upload data to Google Drive after any refresh.
                                            {!isDriveSyncReady && <span className="block text-yellow-500/80">Requires Google Drive sync to be set up.</span>}
                                        </p>
                                    </div>
                                    <label htmlFor="auto-upload-toggle" className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            type="checkbox"
                    ...
                    <div>
                     ...
                     <div>
                        <h3 className="text-sm font-semibold text-gray-400 mb-3 border-b border-gray-700 pb-2">AI & Content</h3>
                        <div className="bg-gray-700/50 p-4 rounded-lg">
                            <div>
                     ...
                     <div>
                        ...
                        <div className="bg-gray-700/50 p-4 rounded-lg space-y-3">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={handleBulkEditClick} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-gray-600 text-white hover:bg-gray-500">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-gray-400 mb-3 border-b border-gray-700 pb-2">App Info & Help</h3>
                        <div className="bg-gray-700/50 p-4 rounded-lg space-y-3">
                            <div className="flex justify-between items-center">
                                <div>
                                ...
                                <button onClick={handleDemoClick} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-gray-600 text-white hover:bg-gray-500">
                            ...
                            <div className="border-t border-gray-600/50"></div>
                             <div className="flex justify-between items-center">
                                ...
                                <button onClick={() => handleInfoClick('about')} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-gray-600 text-white hover:bg-gray-500">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={() => handleInfoClick('help')} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-gray-600 text-white hover:bg-gray-500">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={() => handleInfoClick('privacy-policy')} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-gray-600 text-white hover:bg-gray-500">
                                    <InfoIcon className="w-4 h-4" />
                                    View
                                </button>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={handleClearDataClick} className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-semibold bg-red-600 text-white hover:bg-red-500">
