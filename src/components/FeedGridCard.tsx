...
export const FeedGridCard: React.FC<FeedGridCardProps> = ({
  feed,
  onSelectFeed,
  unreadCount,
  zoomLevel,
    ...
    >
      ...
      {zoomLevel !== 'xl' && (
        <div className="mt-2 text-center">
          <h3
            className={`font-semibold text-gray-200 group-hover:text-indigo-400 transition-colors duration-200 truncate ${titleSizeClasses[zoomLevel]}`}
          >
            {feed.title}
          </h3>
        </div>
